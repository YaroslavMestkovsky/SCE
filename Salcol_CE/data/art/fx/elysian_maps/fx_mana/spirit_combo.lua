fxtypes =  
{
	...
	{
		effect = "root>mana_spray>mana_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_MAPS/_TEXTURES/MANA_PUFF.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_MAPS/_TEXTURES/MANA_WELL_GLOW.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
