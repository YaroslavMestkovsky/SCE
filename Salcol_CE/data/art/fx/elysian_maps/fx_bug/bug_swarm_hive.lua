fxtypes =  
{
	...
	{
		effect = "root>spark_combo>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_MAPS/_TEXTURES/BUG_GLOW.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
		...
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_MAPS/_TEXTURES/BUG_TRAIL.DDS",
				},
				property_04 =  
				{
					name = "ColourHead",
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_MAPS/_TEXTURES/BUG_WINGS.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
