fxtypes =  
{
	...
	{
		effect = "root>chute_spray1>veh_smoke_dark_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_GUARD/_TEXTURES/GENERIC_SMOKE_4.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_GUARD/_TEXTURES/GENERIC_GLOW_3.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
