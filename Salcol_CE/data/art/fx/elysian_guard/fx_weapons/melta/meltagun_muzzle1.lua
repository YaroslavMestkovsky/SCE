fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_GUARD/_TEXTURES/MELTA_PYRUM_GLOW.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>__fxtool_private_copy>env_orbital_debris_smoke_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>env_orbital_debris_smoke_combo>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_GUARD/_TEXTURES/MELTA_FLASH_1.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>__fxtool_private_copy>env_orbital_debris_smoke_combo>pyrum_particle222",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELYSIAN_GUARD/_TEXTURES/MELTA_GLOW_1.DDS",
				},
				property_04 =  
				{
					name = "Offset",
