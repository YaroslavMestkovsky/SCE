fxtypes =  
{
	...
	{
		effect = "root>__fxtool_private_copy>__fxtool_private_copy>necron_beam_1",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>flash_tip_combo_w_sparks_2",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>flash_tip_combo_w_sparks_2>unit_melee_hammer_glow_ring_2",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>flash_tip_combo_w_sparks_2>unit_melee_hammer_flash_glow_ring",
		fx =  
		{
			properties =  
			{
