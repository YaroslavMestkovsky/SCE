fxtypes =  
{
	...
	{
		effect = "root>env_orbital_ground_shock_combo_exp>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>env_orbital_ground_shock_combo_exp>__fxtool_private_copy>env_orbital_shock_smoke_ring_spray_1b",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>env_orbital_ground_shock_combo_exp>__fxtool_private_copy>env_orbital_shock_smoke_ring_spray_1b>env_orbital_shock_smoke_ring",
		fx =  
		{
			properties =  
			{
