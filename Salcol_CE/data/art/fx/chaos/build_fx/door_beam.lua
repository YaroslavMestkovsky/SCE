fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_01 =  
				{
					name = "Fx2",
					type = "VARTYPE_STRING",
					value = "possession_ground_beam_spray2",
				},
				property_02 =  
				{
					name = "FX3",
	...
	{
		effect = "root>possession_ground_beam_spray2",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>possession_ground_beam_spray2>flame_line_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>possession_ground_beam_spray2>flame_line_combo>flame_line_beam",
		fx =  
		{
			properties =  
			{
