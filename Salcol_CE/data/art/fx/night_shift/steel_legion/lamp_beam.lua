fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "STEEL_LEGION/NIGHT_FX/_TEXTURES/PROJECTOR_BEAM.DDS",
				},
				property_04 =  
				{
					name = "Offset",
	...
	{
		effect = "root>unit_battlecry_godlight_beam_combo>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "STEEL_LEGION/NIGHT_FX/_TEXTURES/PROJECTOR_GLOW.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
