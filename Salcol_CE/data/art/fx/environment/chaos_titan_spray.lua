fxtypes =  
{
	...
	{
		effect = "root>steam_small_chaos>env_steam_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "DATA:ART/FX/CHAOS_SMOKE3.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
