fxtypes =  
{
	...
	{
		effect = "root>missile_launcher_smokespray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>missile_launcher_smokespray>rocketlauncher_smokering",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "PLACEHOLDER_FX/LARGE/TEXTURES/LARGE_AH_SMOKE_PUFF.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
