fxtypes =  
{
	...
	{
		effect = "root>particles_spray_gravwell>spark_combo>bug_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>particles_spray_gravwell>spark_combo>bug_combo>muzzle_lascannon_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "DATA:ART/FX/NURGLE/TEXTURE_FLY/FLY_BODY.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>particles_spray_gravwell>spark_combo>bug_combo>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "DATA:ART/FX/NURGLE/TEXTURE_FLY/BUG_WINGS.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
