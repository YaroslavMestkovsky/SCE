fxtypes =  
{
	...
	{
		effect = "root>test2>rocketlauncher_smokespray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>test2>rocketlauncher_smokespray>rocketlauncher_smokering",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>test2>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>test2>__fxtool_private_copy>dreadnought_flame_bright_ring2",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TAU/STRUCTURES/FIRE_PUFF4_02.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>test2>__fxtool_private_copy>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "MUZZLE_TRACER_BLUE_01.TGA",
				},
				property_04 =  
				{
					name = "Offset",
