fxtypes =  
{
	...
	{
		effect = "root>default_combo>muzzle_big_shoota_muzzle_glow_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES_DOW_II/FLASHES/BIG_FLASH_09.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES_DOW_II/MUZZLE_FLASHES/STAR_FLASH_03.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
